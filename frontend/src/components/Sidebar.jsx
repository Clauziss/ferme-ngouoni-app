...
export default function Sidebar() {
  ...
  // Sur téléphone, le menu est un tiroir : refermé automatiquement dès qu'on
  // change de page pour libérer l'écran.
  const [ouvert, setOuvert] = useState(false);
  const position = useLocation();

  React.useEffect(() => { setOuvert(false); }, [position.pathname]);
  ...
  return (
    ...
    {ouvert && <div className="voile-menu" onClick={() => setOuvert(false)} />}
