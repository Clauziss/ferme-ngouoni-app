...
export default function EntityPage({ titre, description, endpoint, colonnes, champs, transformerAvantEnvoi, actionLigne }) {
          ...
          <table>
            <thead>
              <tr>
                ...
                {(utilisateur?.role === "admin" || actionLigne) && <th></th>}
              </tr>
            </thead>
            <tbody>
              {items.map((item) => (
